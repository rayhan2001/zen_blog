                ...
                <div class="row">
                    <div class="col-md-9 post-content" data-aos="fade-up">
                        ...
                        <div class="single-post">
                            ...
                            <p><span class="firstcharacter">{{substr($blog->description,0,1)}}</span>{{substr($blog->description,0,250)}}</p>
                        ...
                        <!-- ======= Comments ======= -->
                        <div class="comments">
                            <h5 class="comment-title py-4">{{ count($comments) }} Comment</h5>
                            ...
                            <form action="{{route('new.comment')}}" method="post">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control mt-2" name="comment" id="comment-message" placeholder="Comment Right Here" cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="col-12">
                        ...
                        @else
                            <h3 class="text-success mt-3">Please <a href="{{route('user.login')}}" class="text-info">Login</a> For Comments</h3>
                        @endif
                    <!-- End Comments Form -->
                            ...
                            <ul class="nav nav-pills custom-tab-nav mb-4">
                                ...
                                <!-- Latest -->
                                    ...
                                    <div class="post-entry-1 border-bottom">
                                        ...
                                        <span class="author mb-3 d-block">{{$categoryWiseBlog->authore_name}}</span>
                                    </div>
                                    @endforeach
                            <!-- End Latest -->
